...
class GlobalFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.first_block = nn.Sequential(Bottleneck(16, 16, 2, 4),
                                         Bottleneck(16, 16, 1, 4),
                                         Bottleneck(16, 16, 1, 4))
        self.second_block = nn.Sequential(Bottleneck(16, 24, 2, 4),
                                          Bottleneck(24, 24, 1, 4),
                                          Bottleneck(24, 24, 1, 4))
        self.third_block = nn.Sequential(Bottleneck(24, 32, 1, 4),
