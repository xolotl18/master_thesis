...
class GlobalFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.first_block = nn.Sequential(Bottleneck(32, 32, 2, 6),
                                         Bottleneck(32, 32, 1, 6),
                                         Bottleneck(32, 32, 1, 6))
        self.second_block = nn.Sequential(Bottleneck(32, 48, 2, 6),
                                          Bottleneck(48, 48, 1, 6),
                                          Bottleneck(48, 48, 1, 6))
        self.third_block = nn.Sequential(Bottleneck(48, 64, 1, 6),
...
class PPMModule(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, sizes=(1, 2, 3, 6)):
        ...
        self.pool2 = nn.AvgPool2d(8)     # produces 2x2x64 feature map
        self.pool3 = nn.AvgPool2d(4)     # produces 4x4x64 feature map
        self.pool4 = nn.AvgPool2d(2)     # produces 8x8x64 feature map
