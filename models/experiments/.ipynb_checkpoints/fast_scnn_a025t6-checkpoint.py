...
class GlobalFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.first_block = nn.Sequential(Bottleneck(16, 16, 2, 6),
                                         Bottleneck(16, 16, 1, 6),
                                         Bottleneck(16, 16, 1, 6))
        self.second_block = nn.Sequential(Bottleneck(16, 24, 2, 6),
                                          Bottleneck(24, 24, 1, 6),
                                          Bottleneck(24, 24, 1, 6))
        self.third_block = nn.Sequential(Bottleneck(24, 32, 1, 6),
