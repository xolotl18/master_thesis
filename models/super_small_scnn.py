...
class SuperSmallSCNN(nn.Module):
...
class GlobalFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.second_block = Bottleneck(16, 16, 2, 2)
        self.third_block = Bottleneck(16, 16, 1, 2)
...
class FeatureFusion(nn.Module):
    def __init__(self, scale_factor):
        ...
        self.conv_high_res = nn.Conv2d(16, 16, kernel_size=1, stride=1, padding=0, bias=True)
